...
![Gminer version](https://img.shields.io/badge/gminer-v3.05-blue?style=flat-square)
...
|------------------|----------------------------------------------------------|----------|
| `GMINER_VERSION` | The version of gminer to build the container with.       | `3.05`   |
...
For example, to build a container with cuda version 11.6.0 and gminer 3.05, run the command

```shell
docker build --build-arg GMINER_VERSION=3.05 --build-arg CUDA_BASE=11.6.0 .
```
