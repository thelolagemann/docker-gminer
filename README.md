...
![Gminer version](https://img.shields.io/badge/gminer-v2.99-blue?style=flat-square)
...
|------------------|----------------------------------------------------------|----------|
| `GMINER_VERSION` | The version of gminer to build the container with.       | `2.99`   |
...
For example, to build a container with cuda version 11.6.0 and gminer 2.99, run the command

```shell
docker build --build-arg GMINER_VERSION=2.99 --build-arg CUDA_BASE=11.6.0 .
```
