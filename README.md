...
![Gminer version](https://img.shields.io/badge/gminer-v2.93-blue?style=flat-square)
...
|------------------|----------------------------------------------------------|----------|
| `GMINER_VERSION` | The version of gminer to build the container with.       | `2.93`   |
...
For example, to build a container with cuda version 11.6.0 and gminer 2.93, run the command

```shell
docker build --build-arg GMINER_VERSION=2.93 --build-arg CUDA_BASE=11.6.0 .
```
